  ...
  return (
    <div style={{ fontFamily: 'sans-serif', backgroundColor: '#fdf8f5', color: '#111' }}>
      <header style={{ backgroundColor: '#b00000', color: 'white', padding: '1.5rem', textAlign: 'center' }}>
        ...
        <a href="https://wa.me/447379366381" target="_blank" rel="noopener noreferrer"
           style={{ backgroundColor: '#ffd700', color: '#b00000', padding: '0.5rem 1rem', borderRadius: '8px', textDecoration: 'none', fontWeight: 'bold' }}>
          Book Now on WhatsApp
        </a>
      </header>

      <section style={{ textAlign: 'center', padding: '4rem 2rem', backgroundImage: 'url(https://upload.wikimedia.org/wikipedia/commons/3/30/Liverpool_Waterfront_2018.jpg)', backgroundSize: 'cover', backgroundPosition: 'center', color: 'white', position: 'relative' }}>
      ...
      <section style={{ padding: '4rem 2rem', backgroundColor: 'white', textAlign: 'center' }}>
        ...
        <form onSubmit={handleWhatsAppSend} style={{ maxWidth: '500px', margin: '0 auto', textAlign: 'left' }}>
          ...
          <textarea value={message} onChange={(e) => setMessage(e.target.value)} required rows="4"
                    style={{ display: 'block', width: '100%', marginBottom: '1rem', padding: '0.75rem' }}></textarea>
      ...
      <footer style={{ backgroundColor: '#b00000', color: 'white', textAlign: 'center', padding: '1rem' }}>
        © {new Date().getFullYear()} Liverpool Taxi Tours | <a href="https://wa.me/447379366381" target="_blank" rel="noopener noreferrer" style={{ color: '#ffd700' }}>Chat on WhatsApp</a>
      </footer>
    </div>
  );
}
